<?php
$i = $l = 0;
$btn_update = array('name'=>'input_e','id'=>$main_data[$i][0]['eid'],'type'=>'button','class'=>'btn btn-warning update','content'=>'更改');
$btn_delete = array('name'=>'person_basic','id'=>$main_data[$i][0]['eid'],'type'=>'button','class'=>'btn btn-danger delete','content'=>'删除');
